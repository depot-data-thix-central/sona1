    ...
    return Scaffold(
      ...
      body: weddingAsync.when(
        ...
        data: (WeddingModel wedding) {
          ...
          final daysLeft = wedding.weddingDate != null ? wedding.weddingDate!.difference(DateTime.now()).inDays.clamp(0, 9999) : 0;
          ...
          return RefreshIndicator(
            ...
            child: ListView(padding: const EdgeInsets.all(16), children: [
              ...
              Row(children: [
                ...
                Expanded(child: _CountdownCard(days: daysLeft, dateStr: wedding.weddingDate?.toString().substring(0, 10) ?? 'À définir')),
              ]),
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Row(children: [
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: 16),
            Row(children: [_InfoChip(icon: Icons.calendar_today, label: 'Date', value: wedding.weddingDate?.toString().substring(0, 10) ?? '-'), const SizedBox(width: 12), _InfoChip(icon: Icons.location_on, label: 'Lieu', value: wedding.venue ?? '-')]),
            const SizedBox(height: 16),
            const Text('Progression globale', style: TextStyle(fontSize: 11)), const SizedBox(height: 4),
            Row(children: [Expanded(child: LinearProgressIndicator(value: 0.0, backgroundColor: Colors.grey[200], color: const Color(0xFF0B3B8F))), const SizedBox(width: 8), const Text('0%', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold))]),
